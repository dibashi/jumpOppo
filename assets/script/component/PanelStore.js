...
export default class PanelStore extends cc.Component {
    ...
    onLoad() {
        ...
        toolsLog("--- onLoad Store ---" + posX + " -- " + cc.dataMgr.haveProp.useRoleIdx);
    ...
    checkContentPos() {
        ...
        //toolsLog("-- checkPos: " + num + " -- " + this.node_content.x);
        if (!this._onMoving) {
            this._onMoving = true;
    ...
    scrollEvent(sender, event) {
        switch (event) {
            case 0:
                //toolsLog("Scroll to Top");
                break;
            case 1:
                //toolsLog("Scroll to Bottom");
                break;
            case 2:
                //toolsLog("Scroll to Left");
                break;
            case 3:
                //toolsLog("Scroll to Right");
                break;
            case 4:
                //toolsLog("Scrolling");
                break;
            case 5:
                ...
                break;
            case 6:
                //toolsLog("Bounce bottom");
                break;
            case 7:
                //toolsLog("Bounce left");
                break;
            case 8:
                //toolsLog("Bounce right");
                break;
            case 9:
                //toolsLog("Auto scroll ended");
                this.checkContentPos();
                break;
        }
    }
    ...
    shareFriend() {
        ...
        //     });
        // } else {
        //     //toolsLog("-- Not is wechatGame store --");
        //     cc.dataMgr.shareSuccess("store");
        // }
    }
}