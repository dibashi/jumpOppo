...
export default class PanelInvite extends cc.Component {
    ...
    isHaveTake_b(idx) {
        toolsLog("-- isHaveTake --" + idx);
        toolsLog(cc.dataMgr.haveProp.inviteTake);
        let haveTake = false;
    ...
    onClickBtn(event, customeData) {
        if (event.target) {
            ...
            if (btnN == "anniu_zhuyie") {
                ...
                //     });
                // } else {
                //     //toolsLog("-- Not is wechatGame PanelRelive --");
                // }
            }
