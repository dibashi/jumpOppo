...
export default class PanelStart extends cc.Component {
    ...
    initStart() {
        ...
        this.rankingView.getChildByName("anniu_backEnd").x = cc.dataMgr.isShowShare ? 100 : 0;

        this.node.getChildByName("more_icon").active = cc.dataMgr.showMoreGame;
        // this.node.getChildByName("anniu_paiming").x = cc.dataMgr.showMoreGame ? -120 : -60;
        // this.node.getChildByName("anniu_weixin").x = cc.dataMgr.showMoreGame ? -240 : -180;
        // this.node.getChildByName("anniu_yinyue").x = cc.dataMgr.showMoreGame ? 120 : 60;
        // this.node.getChildByName("anniu_shezhi").x = cc.dataMgr.showMoreGame ? 240 : 180;
    }
    ...
    initStartBox() {
        ...
        // //获取超越好友的数据
        // if (CC_WECHATGAME) {
        //     //toolsLog("-- WECHAT Start.js subPostMessage --");
    ...
    showGroup() {
        ...
        //     toolsLog("-- 开局显示群排行 --" + cc.dataMgr.shareTicket);
    ...
    onClickBtn(event, customeData) {
        if (event.target) {
            toolsLog("--- PanelStart --- " + cc.dataMgr.userData.isReady)
    ...
    initSubCanvas() {
        ...
        // if (CC_WECHATGAME) {
        //     //toolsLog("-- WECHAT Start.js initSubCanvas --");
    ...
    updataSubCanvas() {
        ...
        //     //toolsLog("-- WECHAT Start.js updataSubCanvas --");
